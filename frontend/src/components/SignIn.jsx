  ...
  return (
    <div className="w-full sm:w-10/12 md:w-8/12 lg:w-1/2 rounded-3xl  px-6 py-4 my-5 bg-gray-100 shadow-md">
                ...
                <form onSubmit={handleSubmit} className="mt-10">
                    ...
                    <div>
                        <input type="text" name='name' placeholder="Email address..." className="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0 p-2"/>
                        {/* {nameError && <p className='text-red-600'>* {nameError}</p> } */}
                    </div>

                    <div className='mt-2'>
                        <input  type="password" name='lastName' placeholder="Password ..." className="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0 p-2"/>
                    </div>
                    ...
                    <div className="mt-7">
                        <div className="flex justify-center items-center">
                            ...
                            <LinkRouter to={'/singup'} href="#" className=" text-blue-500 transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
                                Sign Up
                            </LinkRouter>
                        </div>
                    </div>
