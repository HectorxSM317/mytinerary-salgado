...
export default function CardDetail({ city }) {
  console.log(city);
  return (
    <div className="w-11/12 flex flex-col items-center sm:p-4">
      <div className="
      transition 
      duration-500 
      ease-in-out 
      ...
      flex flex-row lg:w-9/12 sm:my-10 rounded-3xl shadow-2xl justify-center flex-wrap shadow-slate-200/25 p-5">
        ...
        <div className="flex flex-col items-center justify-center">
          <h2 className="text-white text-4xl ">{city[0].name}</h2>
          <h3 className="text-white text-3xl pl-4">{city[0].country}</h3>
        </div>
      </div>
      ...
      <div className="w-full flex justify-center md:mt-10 xl:mt-14 lg:justify-center flex-wrap">
        ...
        <div className=" md:w-2/6 flex justify-center ms:justify-end my-3 sm:my-0 flex-grow items-center text-center sm:text-left">
          <p className="text-white text-xl sm:w-5/6">
            ...
            sapiente ut tempore autem enim, at possimus illo amet natus sapiente
            ut tempore autem enim, at possimus illo amet natus sapiente ut
            tempore autem enim, at possimus illo amet natus.
          </p>
        </div>
